...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      'A secure, local-first quiz management system for academic institutions featuring a proctored JavaFX desktop client, an mDNS-discoverable Spring Boot local database server, and a React results web portal synced with MongoDB Atlas.',
    techStack: [
      'academic-software',
      'desktop-application',
      'exam-system',
